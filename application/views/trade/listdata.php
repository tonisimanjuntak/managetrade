    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Trade</h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                        ...
                        foreach ($rsbalance->result() as $row) {
                          ...
                          echo '
                            ...
                            <tr class="" style="">
                              ...
                              <td style="text-align: center; width: 15%;"><a href="'.site_url( 'trade/entrytrade/'.$this->encrypt->encode($row->idbalance) ).'" class="btn btn-sm btn-success btn-circle"><i class="fa fa-plus-circle"></i> Trade</a></td>
                            </tr>
