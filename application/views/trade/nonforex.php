                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group row required">
                        ...
                        <div class="col-md-9">
                          <select name="idpair" id="idpair" class="form-control">
                      ...
                      <div class="form-group row required">
                        <label for="" class="col-md-3 col-form-label">Qty/ Lembar</label>
                        <div class="col-md-9">
                        ...
                        <table class="table table-bordered table-condesed" id="table">
                          <thead>
                            <tr class="bg-primary" style="">
                              ...
                              <th style="text-align: center;">Qty/ Lembar</th>
                              <th style="text-align: center;">Entry Price</th>
                              <th style="text-align: center;">Exit Price</th>
                              <th style="text-align: center;">Jumlah Saldo</th>
                          ...
                          <tfoot>
                            <th style="text-align: right; font-weight: bold; font-size: 20px;" colspan="6">TOTAL: </th>
                            <th style="text-align: right; font-weight: bold; font-size: 20px"></th>
                            <th style="text-align: right; font-weight: bold; font-size: 20px"></th>
                            <th style="text-align: right; font-weight: bold; font-size: 20px"></th>
                            <th style="text-align: right; font-weight: bold; font-size: 20px"></th>
                            <th style="text-align: right; font-weight: bold; font-size: 20px"></th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('trade/datatablesource_nonforex')?>",
            "type": "POST",
            "data": function ( d ) {
