    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          ...
          <a href="<?php echo(site_url('currency/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('currency/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
