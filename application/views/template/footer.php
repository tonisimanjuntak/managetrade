...
<script>
    ...
    $(".persen").mask("000.00", {reverse: true, placeholder:"000.00"});
    $('.persen').addClass('text-right');
    ...
    $(".pairprice").mask("000,000.000000", {reverse: true, placeholder:"000,000.000000"});
    $('.pairprice').addClass('text-right');
