    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          ...
          <a href="<?php echo(site_url('pengguna/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="text-align: center;">Nama Pengguna<br>Jenis Kelamin</th>
                      <th style="text-align: center;">HP<br>Email</th>
                      <th style="text-align: center;">Username<br>Terakhir Login</th>
